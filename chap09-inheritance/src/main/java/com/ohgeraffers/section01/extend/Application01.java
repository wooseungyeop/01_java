...
public class Application01 {
    ...
    public static void main(String[] args){
        ...
        특히 메소드 재정의(overrriding)라는 기술을 이용해서 부모가 가진 메소드를 재정의 하는 것도 가능하다.

        메소드 재정의(overriding)이란 무고가 가지는 메소드 선언부를 그대로 사용하면서
        자식클래스가 정의한 메소드대도 동작하도록 구현 몸체 부분을 새롭게 다시 작성하는 기술이다.
        ...
        1. 새로운 클래스를 작성할 시 기존에 작성한 클래스를 재사용할 수 있다.
            ...
            상속 구조가 복잡해 질수록 그 영향에 대한 예층이 힘들며 이러한 단점이 유지보수성 증가한다는 장점과
            반대로 유지보수에 악영향을 미친다.
           ...
           장점과 단점을 고려했을 때,
           상속은 재사용이라는 장점만 바라보게 되면 오용의 가능성이 있기 때문에 유지보수에 좋지 않는 코드를 작성할때
           ...
           객체별로 그 메세지에 응답하는 방식은 서로 다를 수 잇따.(다양성)
         */
